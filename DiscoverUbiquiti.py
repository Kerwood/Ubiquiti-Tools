...
def print_ubnt():   
    ...
    print
    print
    print "Other Ubiquiti Devices"
    print
    print(FORMAT % ('IP', 'MAC', 'Model', 'Version', 'Inform URL'))
    ...
    for line in splitted:
        ...
        if "04:18:d6" in line:           
            ...
            try:
                ...
                inform = "Could not connect to device!.."
                                
            print(str(FORMAT % (ip, mac, model, version, inform)))
